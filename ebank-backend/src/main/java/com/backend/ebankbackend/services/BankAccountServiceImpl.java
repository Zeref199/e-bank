...
import com.backend.ebankbackend.dtos.*;
import com.backend.ebankbackend.entities.*;
import com.backend.ebankbackend.enums.OperationType;
import com.backend.ebankbackend.exceptions.BalanceNotSufficientException;
...
import com.backend.ebankbackend.mappers.BankAccountMapperImpl;
...
//        }
    ...
    public BankAccountDTO getBankAccount(String accountId) throws BankAccountNotFoundException {
        ...
        BankAccount bankAccount = bankAccountRepository.findById(accountId).orElseThrow(()->new BankAccountNotFoundException("SavingBankAccountDTO not found"));
    ...
    public void transfer(String accountIdSource, String accountIdDestination, double amount) throws BankAccountNotFoundException, BalanceNotSufficientException {
        debit(accountIdSource, amount, "Transferred the amount " + amount + " to "+ accountIdDestination);
        credit(accountIdDestination, amount, "Transferred the amount " + amount + " from " + accountIdSource);
    ...
    public List<BankAccountDTO> bankAccountList() {
        ...
        return bankAccounts.stream().map(bankAccount -> {
            if (bankAccount instanceof SavingAccount) {
                ...
                // Handle other types of accounts if needed
